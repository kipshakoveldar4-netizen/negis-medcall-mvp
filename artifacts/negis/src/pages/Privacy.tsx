...
export default function Privacy() {
  return (
    <LegalPage title="Политика конфиденциальности Medina OS" heading="Политика конфиденциальности Medina OS" updated="1 июля 2026">
      <p style={P}>
        Medina OS предоставляет CRM и инструменты автоматизации для клиник. Оператором сервиса на этапе MVP является Medina OS. Эта политика описывает, какие данные могут обрабатываться при использовании CRM, рекламных модулей и интеграций.
      </p>
