...
export default function Terms() {
  return (
    <LegalPage title="Условия использования Medina OS" heading="Условия использования Medina OS" updated="1 июля 2026">
      <p style={P}>
        Настоящие условия описывают базовые правила использования сервиса Medina OS. Это MVP-текст для публикации и проверки приложения Meta; финальный договор может быть уточнён отдельно.
      </p>

      <Section title="1. О сервисе">
        <p style={P}>
          Medina OS помогает клиникам управлять CRM, заявками, клиентами, записью, задачами, контентом и рекламой. Сервис может включать AI-инструменты, интеграции с Supabase, Telegram, Meta/Facebook/Instagram и OpenAI.
        </p>
      </Section>

      <Section title="2. Ответственность пользователя">
        <p style={P}>
          Пользователь и клиника отвечают за корректность данных, медицинских формулировок, рекламных обещаний, офферов, цен, противопоказаний и другой информации, которую они вводят или подтверждают в Medina OS.
        </p>
      </Section>

      <Section title="3. CRM, клиенты и сотрудники">
        <p style={P}>
          Клиника самостоятельно отвечает за законность обработки данных своих клиентов, пациентов и сотрудников. Medina OS предоставляет технический инструмент для хранения, обработки и организации таких данных внутри рабочего пространства клиники.
        </p>
      </Section>
      ...
      <Section title="5. Правила Meta и результат рекламы">
        <p style={P}>
          Meta/Facebook/Instagram может отклонять объявления, креативы, аудитории или кампании по своим правилам. Medina OS не гарантирует одобрение рекламы, количество заявок, стоимость лида, продажи, запись пациентов или иной коммерческий результат.
        </p>
      </Section>

      <Section title="6. Рекламный бюджет">
        <p style={P}>
          Рекламный бюджет оплачивается отдельно в Meta рекламном аккаунте клиента. Medina OS не является платёжным посредником Meta и не управляет списаниями рекламного кабинета, кроме технической передачи параметров кампании при подтверждённом запуске.
        </p>
      </Section>
      ...
      <Section title="9. Ограничение ответственности">
        <p style={P}>
          Medina OS предоставляется как рабочий инструмент. Сервис не заменяет юридическую, медицинскую, рекламную или финансовую экспертизу. Пользователь принимает решения о публикации рекламы и использовании данных самостоятельно.
        </p>
      </Section>
