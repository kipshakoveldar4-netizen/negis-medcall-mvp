...
async function checkAdsAutomationSource() {
  ...
  assertSourceIncludes(source, "Проверка без запуска. Кампания не создавалась.", "dry-run history badge");
  assertSourceIncludes(source, "Выключено", "real PAUSED history badge");
